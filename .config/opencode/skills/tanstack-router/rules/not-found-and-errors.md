...
- **rules/data-loading.md** — notFound() thrown in loaders interacts with error boundaries and loader data availability. errorComponent retry requires router.invalidate().
- **rules/type-safety.md** — notFoundComponent data is typed as unknown; validate before use.
