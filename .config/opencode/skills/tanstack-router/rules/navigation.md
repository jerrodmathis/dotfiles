...
- See also: **rules/search-params.md** — Link search prop interacts with search param validation
- See also: **rules/type-safety.md** — from narrowing improves type inference on Link
