...
- **rules/data-loading.md** — Loader splitting decisions affect data loading performance. Splitting the loader adds latency before data can be fetched.
- **rules/type-safety.md** — getRouteApi is the type-safe way to access hooks from split files.
