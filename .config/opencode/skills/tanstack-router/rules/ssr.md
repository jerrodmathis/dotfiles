...
> **CRITICAL**: TanStack Router is CLIENT-FIRST. Loaders run on the client by default. With SSR enabled, loaders run on BOTH client AND server. They are NOT server-only like Remix/Next.js loaders.
...
See **rules/data-loading.md** for loader fundamentals.

## Cross-References

- **rules/data-loading.md** — SSR changes where loaders execute
